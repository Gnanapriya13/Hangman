let s = ["ocean", "pyramid", "jupiter", "bicycle", "vampire"];
...
ok.onclick = function () {
  ...
  if (word === "ocean") {
    mes.textContent = `A large body of salt water covering most of earth's surface.`;
  }
  if (word === "pyramid") {
    mes.textContent = `A triangular-shaped ancient structure found in Egypt.`;
  }
  if (word === "jupiter") {
    mes.textContent = `The largest planet in our solar system.`;
  }
  if (word === "bicycle") {
    mes.textContent = `A two-wheeled vehicle powered by pedaling.`;
  }
  if (word === "vampire") {
    mes.textContent = `A mythical creature that drinks blood.`;
  }
